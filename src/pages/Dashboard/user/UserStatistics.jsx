                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div
                            ...
                            <div className="h-20 md:h-32 rounded-xl mt-11 shadow-md p-6 bg-orange-500">
                                <div className="flex items-center font-semibold mb-2 -mt-3 md:-mt-3 text-lg md:text-xl text-white">
                    ...
                    <div className="flex flex-col md:flex-row h-64 mt-6">
                        <div className="bg-white rounded-xl shadow-lg mb-4 md:mb-0 px-6 py-4 w-full md:w-4/12">
                            ...
                            <div className="h-10 md:h-10 rounded-xl mt-2 shadow-md p-6 bg-orange-500">
                                <div className=" flex items-center font-semibold mb-1 -mt-4 md:-mt-4 text-lg md:text-xl text-white">
                                    <MdEmail className="mr-4 text-3xl"></MdEmail>
                                    Contact Info
                                </div>
                            </div>

                            <div className="flex justify-between flex-col h-30 md:h-32 rounded-xl mt-7 shadow-md p-6 bg-orange-500">
                                <div className="flex items-center  font-semibold mb-1 -mt-3 md:-mt-3 text-lg md:text-xl text-white">
                            ...
                            <div className="bg-white cursor-pointer shadow rounded-lg mt-3 flex">
                                ...
                                <div className="w-full p-4">
                                    ...
                                    <p className="w-full text-base leading-6 mt-4 text-gray-600 ">
                                        ...
                                        An user needs to do a transaction with at least $50. Less than $50 is not allowed for transactions.
